...
ENV OPENCV https://github.com/opencv/opencv/archive/4.0.1.tar.gz
ENV OPENCV_VER 4.0.1
...
RUN apk add -U --no-cache --virtual=build-dependencies \
    ...
    && apk add --no-cache gcc  zlib jpeg libjpeg freetype openjpeg curl python3 \
